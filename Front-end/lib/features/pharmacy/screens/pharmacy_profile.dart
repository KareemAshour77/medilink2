...
class _PharmacyProfileState extends State<PharmacyProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    final items = [
      ...
      _MenuItem.icon(Icons.notifications_active_outlined, l.notifications, const Color.fromARGB(255, 130, 169, 14), ''),
      _MenuItem.icon(Icons.help_outline_rounded, l.helpSupport, AppColors.grey, ''),
    ];
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(l.menu,
                    style: TextStyle(
                        color: context.text, fontSize: 24, fontWeight: FontWeight.bold)),
              ],
            ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  colors: [RoleTheme.pharmacy, RoleTheme.pharmacy],
